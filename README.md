...
[Website Source](website/index.html) · [Dashboard Source](start_page.html) · [Machine View Source](pages/machines.html)
...
| Area | Details |
|---|---|
| Domain | Smart manufacturing and cyber-physical systems |
| My role | Front-End & Product Design Engineer / UX Research Lead |
| Focus | Product interface design, sensor-data dashboards, UX research, and industrial-systems research |
| Technologies | HTML, CSS, JavaScript, Figma |
| Project period | June–August 2026 |
| Status | Functional front-end prototype using demonstration data |
